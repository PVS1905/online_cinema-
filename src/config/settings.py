...
class CelerySettings(BaseSettings):
    REDIS_PASSWORD: str = "redis_password"  # Переконайтеся, що це співпадає з env REDIS_PASSWORD

    # Замість @property просто оголосимо як атрибути класу
    CELERY_BROKER_URL: str = f"redis://:{REDIS_PASSWORD}@redis:6379/0"
    CELERY_RESULT_BACKEND: str = f"redis://:{REDIS_PASSWORD}@redis:6379/1"
